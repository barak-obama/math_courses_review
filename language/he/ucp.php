...
$lang = array_merge($lang, array(
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'אם החשבון שלך קיים, נשלחה אלייך סיסמא חדשה לאימייל הרשום. אם לא קיבלת אימייל, ייתכן שזה בגלל שהחשבון שלך לא מופעל, קיבלת באן, או שאתה לא רשאי לשנות את הסיסמא שלך. צור קשר עם הנהלת הפורום אם הסיבות הללו לא תקפות. בכל מקרה מומלץ לבדוק את תיקיית הספאם באימייל שלך.',
